...
\item<2-6> Number of reconstructed muons for \only<2>{0}\only<3>{1}\only<4>{2}\only<5>{3}\only<6>{4} generator-level muon\only<2>{s}\only<4>{s}\only<5>{s}\only<6>{s}
\end{itemize}

\begin{center}
\only<1>{\includegraphics[height=0.8\linewidth, angle=90]{tracks_lastpage_allreal.pdf}}
\only<2>{\includegraphics[height=0.8\linewidth, angle=90]{tracks_lastpage_0real.pdf}}
\only<3>{\includegraphics[height=0.8\linewidth, angle=90]{tracks_lastpage_1real.pdf}}
\only<4>{\includegraphics[height=0.8\linewidth, angle=90]{tracks_lastpage_2real.pdf}}
\only<5>{\includegraphics[height=0.8\linewidth, angle=90]{tracks_lastpage_3real.pdf}}
\only<6>{\includegraphics[height=0.8\linewidth, angle=90]{tracks_lastpage_4real.pdf}}
\end{center}
\end{frame}
